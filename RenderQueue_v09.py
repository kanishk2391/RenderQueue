...
class RenderQueue(object):
    ...
    def deleteAnimItem(self):
        ...
        tree = ET.ElementTree(file='E:/PythonStuff/RenderQueue/queue.xml')
        root = tree.getroot()
        for elements in root:
            if str(elements.attrib["FileName"])=="AnimFile05.ma":
                root.remove(elements)
                tree.write('E:/PythonStuff/RenderQueue/queue.xml')
